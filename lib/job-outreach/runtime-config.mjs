...
export function getJobOutreachConfig() {
  ...
  return {
    ...
    targetRoles: (process.env.JOB_OUTREACH_TARGET_ROLES || "AI Native Fullstack Engineer,AI Engineer,Applied AI Engineer,Full Stack Engineer,Senior Full Stack Engineer,Python Engineer,React Engineer,Frontend Engineer,Backend Engineer,Product Engineer,Founding Engineer,Software Engineer AI Systems,Solutions Engineer").split(/[\n,]/).map((role) => role.trim()).filter(Boolean),
    ...
    resumeUrl: process.env.JOB_OUTREACH_RESUME_URL || "",
    resumeDriveFileId: process.env.JOB_OUTREACH_RESUME_DRIVE_FILE_ID || "",
